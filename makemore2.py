...
Моја анализа резултата:

Модел који користим је направљен већ 2003,
и резултати који су добијени су већински смислени и налик именима
која имамо у нашем језику. Задивљујуће је направити нешто у
овако једноставнијој и разумљивијој структури и видети задовољавајуће
резултате са овом комплексношћу.

Оно што фали моделу је додатна комплексност да разуме односе слова унутар
речи и делова који их сачињавају. Осим саме комплексности, треба
имплементирати и додатну логику која би моделу дала слободу да буде
